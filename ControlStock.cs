...
namespace APP
{
    public class ControlStock
    {
        ...
        /// データベース
        private ControlDataBase DataBase = new ControlDataBase(Define.defStockDataFile);
        ...
        public void LoadFile()
        {
            ...
            /// タイトルを設定する
            ofd.Title = "納期ファイルを選択してください。";

            Load("C:\\Users\\makoto\\Documents\\Project\\INABA-納期調整\\sampledata\\進工業　出荷一覧　最新　本日入荷.xlsx");
            /*
