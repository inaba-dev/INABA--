...
namespace APP
{
    public partial class FormOrder : Form
    {
        ...
        public void Reload()
        {
            ...
            /// クエリ(有効/無効)
            if (!checkAllOption.Checked)
            {
                query = execQueryStatus(query, false);
            }
        ...
        private void dataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    /// 引当数量
                    var quantity = dataGridView.Rows[e.RowIndex].Cells[8].Value;

                    OrderDataBase.Commit((string)index, (int)quantity);
