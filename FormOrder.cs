...
namespace APP
{
    public partial class FormOrder : Form
    {
        ...
        public FormOrder()
        {
            ...
            dataGridView.setupColumnTxtCenter(col8,  8,  85,  "Delivery", "引当数", "");
        ...
        public void SetupProduct(string productname)
        {
            try
            {
                selectProduct.SelectedItem = productname;
            }
            catch
            {
        ...
        public void Reload()
        {
            ...
            foreach (var row in query)
            {
                ...
                int fixedquantity = StockQuantity((string)row["ProductName"], (int)row["Quantity"]);
            ...
            try
            {
                ...
                //if (CurrentRow > 0)
                //{
                //    dataGridView.FirstDisplayedScrollingRowIndex = CurrentRow;//.Rows[CurrentRow].Selected = true;
                //}
            }
            catch
            {
        ...
        private void labelSearch_Click(object sender, EventArgs e)
        {
            ...
            ///
            string productnumber = (string)selectProduct.SelectedItemEx();           
            
            ///
            userControlStatus.Renew
                (
                    productnumber,
                    GetStockNumber(productnumber).ToString(),
                    GetOrderNumber(productnumber).ToString()
                );
        }
        ...
        private void dataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    OrderDataBase.ChangeStatus((string)index);
                ...
                else if (dgv.Columns[e.ColumnIndex].Name == "編集")
                {
                    ...
                    FormRegist.LoadTitle("出荷編集画面");
                    FormRegist.SetParam(OrderDataBase.GetData((string)index));
                    ...
                    if (FormRegist.ShowDialog(this) == DialogResult.OK)
                    {
                        ...
                        /// 削除
                        OrderDataBase.Delete((string)index);

                        /// 追加
                        OrderDataBase.Add(data);
                    }
